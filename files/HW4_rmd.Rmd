...
nuclear_perfs
```
Penalized regression comes first for this question also.
cv result of gbm is not consistent with test result. We may overfit in that one.
...
Gbm is the best performer for 2 questions. Then, lasso regression comes. 3rd one is random forest. Rpart is the worst one.
